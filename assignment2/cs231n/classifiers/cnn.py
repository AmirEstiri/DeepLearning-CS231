...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(0.0, weight_scale, (num_filters * input_dim[1] * input_dim[2] // 4, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        scores, cache4 = affine_forward(out3, W3, b3)
        ...
        dout3, dW3, db3 = affine_backward(dscores, cache4)
        dout2, dW2, db2 = affine_relu_backward(dout3, cache3)
        dout1 = max_pool_backward_fast(dout2, cache2)
